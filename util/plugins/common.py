...
def proxy_scrape(): 
    ...
    startTime = time.time()
    #create temp dir
    temp = getTempDir()+"\\logged_proxies"
    print(f"{Fore.YELLOW}Please wait while Logged Scrapes proxies for you!{Fore.RESET}")
    ...
    setTitle(f"Logged {THIS_VERSION}")
